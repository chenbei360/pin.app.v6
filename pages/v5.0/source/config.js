 ...
 *  appDebug   可选配置
 *  ...        可选配置
 *  更多配置参考 : http://w5.pintuan-xcx.cn
 */

// app.json 中配置 小程序全局名称 window.navigationBarTitleText
...
var Config = {
    //默认分享文字
     ...
     //接口 基础 url
     "baseApiUrl": "https://test5.pintuan-xcx.cn/index.php",
    //  "baseApiUrl": "http://pinv5.cn/index.php",
     //"baseApiUrl":"https://3333.pintuan-xcx.cn/index.php",
     
     
    //网站配置
    "web" :  {
        "url": "test5.pintuan-xcx.cn",
        "name" : "微拼"
    },
    //是否开启测试
    "appDebug" : false,
    ...
    //页面加载提示信息
     pullload_text: {
        ...
        banner_image_url: "http://139.199.168.122:8989/Public/Api/images/default_banner.png"      
};
