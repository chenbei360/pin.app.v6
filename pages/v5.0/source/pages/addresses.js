...
Page({
  ...
  selectedDEFAULT:function(obj) {
      ...
      var url = this.baseApiUrl + "/Api/Weuser/addresses?token=" + this.token + "&address_id=" + data[index].address_id;
      util.ajax({
          "url" :  url,
          "method" :　"PUT",
          "data" : {"status" : "DEFAULT"},
   ...
   addressList:function(){{
      ...
      var url = this.baseApiUrl + "/Api/Weuser/addresses?token=" + this.token;
      util.ajax({
          "url" :  url,
          "method" :　"POST",
