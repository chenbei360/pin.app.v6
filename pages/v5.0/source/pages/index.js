...
Page({
  ...
  pullDown: function( e ) {
    if (this.data.is_over == 1 || this.data.goods.length <=0) return false;
  ...
  bannerList:function() {
    var url = this.baseApiUrl + "/Api/Banner/lists";
    ...
    util.ajax({
      ...
      "success" : function(data) {
        ...
        {
          data.banners = [{
            'image_url': util.config('banner_image_url'),
          }];
        }
