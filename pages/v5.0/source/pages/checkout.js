...
Page({
  ...
  doneOrderBanner : function() {
    var url = this.baseApiUrl + "/Api/Project/do_order_banner";
    var self = this;
    util.ajax({
      url : url,
  ...
  btnOrderDone:function(e){
    ...
    var url = this.baseApiUrl + "/Api/Weuser/orders?token=" + this.token;
  ...
  address:function(){{
      ...
      var url = this.baseApiUrl + "/Api/Weuser/addresses?token=" + this.token + pra;
      util.ajax({
          "url" :  url,
          "method" :　"GET",
          "success" : function(data) {
  ...
  goodsDetail:function(){
     var url = this.baseApiUrl + "/Api/Goods/detail?goods_id=" + this.goods_id;
     var self = this;
     util.ajax({
        url : url,
        success : function(data){
