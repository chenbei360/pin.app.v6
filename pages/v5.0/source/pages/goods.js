...
Page({
  ...
  goodsDetail: function (goods_id, obj = {}){
     ...
     var url = this.baseApiUrl + "/Api/Goods/detail?goods_id=" + goods_id;
     var self = this;
     util.ajax({
        url : url,
        success : function(data){
            if(data.result == 'ok') {
              ...
              WxParse.wxParse('goods_desc', 'html', data.goods.goods_desc, self, 0);
  ...
  goodsGroups:function(goods_id) {
    var url = this.baseApiUrl + "/Api/Goods/groups?goods_id=" + goods_id;
    var self = this;
